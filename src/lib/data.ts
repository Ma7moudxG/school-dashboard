...
export const calendarEvents = [
  {
    ...
    end: new Date(2024, 10, 3, 10, 50),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 5, 9, 0),
    end: new Date(2024, 10, 5, 9, 50),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 6, 12, 0),
    end: new Date(2024, 10, 6, 12, 50),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 10, 7, 11, 0),
    end: new Date(2024, 10, 7, 11, 50),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 10, 7, 13, 0),
    end: new Date(2024, 10, 7, 13, 50),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 10, 7, 14, 0),
    end: new Date(2024, 10, 7, 14, 50),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 8, 9, 0),
    end: new Date(2024, 10, 8, 9, 50),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 8, 10, 0),
    end: new Date(2024, 10, 8, 10, 50),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 10, 8, 11, 0),
    end: new Date(2024, 10, 8, 11, 50),
  },

  {
    ...
    end: new Date(2024, 10, 8, 8, 50),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 10, 4, 8, 0),
    end: new Date(2024, 10, 4, 8, 50),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 4, 10, 0),
    end: new Date(2024, 10, 4, 10, 50),
  },

  {
    ...
    end: new Date(2024, 10, 4, 13, 50),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 10, 4, 14, 0),
    end: new Date(2024, 10, 4, 14, 50),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 15, 9, 0),
    end: new Date(2024, 10, 15, 9, 50),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 15, 10, 0),
    end: new Date(2024, 10, 15, 10, 50),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 10, 15, 11, 0),
    end: new Date(2024, 10, 15, 11, 50),
  },

  {
    ...
    end: new Date(2024, 10, 15, 14, 50),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 10, 16, 8, 0),
    end: new Date(2024, 10, 16, 8, 50),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 16, 9, 0),
    end: new Date(2024, 10, 16, 9, 50),
  },

  {
    ...
    end: new Date(2024, 10, 16, 11, 50),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 10, 16, 13, 0),
    end: new Date(2024, 10, 16, 13, 50),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 10, 16, 14, 0),
    end: new Date(2024, 10, 16, 14, 50),
  },
];